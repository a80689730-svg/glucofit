import { j as jsxRuntimeExports, c as cn, f as commonjsGlobal, g as getDefaultExportFromCjs, r as reactExports, h as clsx, R as React, i as invariant, u as useNavigate } from "./index-BSjU2GqU.js";
import { u as useBackendActor, c as useQuery, d as apiGetMyHealthEntries } from "./api-BZjA4YsM.js";
import { S as Sidebar, H as Header, C as Card, c as CardContent, B as Badge, a as CardHeader, b as CardTitle, d as ChartNoAxesColumn } from "./card-BSNiUgki.js";
...
function StatsSkeleton() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-2 gap-4 lg:grid-cols-4", children: [1, 2, 3, 4].map((i) => /* @__PURE__ */ jsxRuntimeExports.jsx(Card, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs(CardContent, { className: "pt-5", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(Skeleton, { className: "h-9 w-9 rounded-lg mb-3" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(Skeleton, { className: "h-7 w-24 mb-2" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(Skeleton, { className: "h-3 w-20" })
  ] }) }, i)) });
}
function ChartSkeleton({ height = 250 }) {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { height }, className: "flex flex-col gap-3 pt-2", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex gap-2", children: [1, 2, 3, 4, 5, 6, 7].map((i) => /* @__PURE__ */ jsxRuntimeExports.jsx(
      Skeleton,
      {
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex justify-between", children: [1, 2, 3, 4, 5].map((i) => /* @__PURE__ */ jsxRuntimeExports.jsx(Skeleton, { className: "h-3 w-10" }, i)) })
  ] });
}
function TimeRangeButton({ value, active, onClick }) {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "button",
    {
      ...
      className: `px-4 py-1.5 rounded-full text-sm font-medium transition-colors ${active ? "bg-primary text-primary-foreground shadow-sm" : "bg-muted text-muted-foreground hover:bg-muted/70"}`,
      children: [
        value,
        " days"
      ]
...
function SortIcon({ dir }) {
  if (!dir) return /* @__PURE__ */ jsxRuntimeExports.jsx(ArrowUpDown, { className: "h-3.5 w-3.5 ml-1 opacity-50" });
  return dir === "asc" ? /* @__PURE__ */ jsxRuntimeExports.jsx(ArrowUp, { className: "h-3.5 w-3.5 ml-1 text-primary" }) : /* @__PURE__ */ jsxRuntimeExports.jsx(ArrowDown, { className: "h-3.5 w-3.5 ml-1 text-primary" });
}
function ReportsPage() {
  ...
  ].sort((a2, b2) => Number(a2.readingTime) - Number(b2.readingTime));
  const weightAll = [...(healthPage == null ? void 0 : healthPage.weightEntries) ?? []].sort(
    (a2, b2) => Number(a2.recordedAt) - Number(b2.recordedAt)
  );
  const glucoseFiltered = glucoseAll.filter(
    (e3) => Number(e3.readingTime) >= cutoff
  );
  const weightFiltered = weightAll.filter(
    (e3) => Number(e3.recordedAt) >= cutoff
  );
  const avgGlucose = glucoseFiltered.length ? Math.round(
    glucoseFiltered.reduce((s2, e3) => s2 + e3.value, 0) / glucoseFiltered.length
  ) : null;
  const minGlucose = glucoseFiltered.length ? Math.min(...glucoseFiltered.map((e3) => e3.value)) : null;
  const maxGlucose = glucoseFiltered.length ? Math.max(...glucoseFiltered.map((e3) => e3.value)) : null;
  const latestWeight = weightFiltered.at(-1) ?? weightAll.at(-1);
  const totalEntries = glucoseFiltered.length + weightFiltered.length;
  const avgInRange = avgGlucose !== null && avgGlucose >= 70 && avgGlucose <= 140;
  const glucoseData = glucoseFiltered.map((e3) => ({
    date: formatDateShort(e3.readingTime),
    glucose: e3.value
  }));
  const weightData = weightFiltered.map((e3) => ({
    date: formatDateShort(e3.recordedAt),
    weight: e3.value
  }));
  const allRows = [
    ...glucoseAll.map(
  ...
  const filteredRows = allRows.filter((r) => typeFilter === "all" || r.type.toLowerCase() === typeFilter).sort(
    (a2, b2) => sortDir === "desc" ? Number(b2.ts) - Number(a2.ts) : Number(a2.ts) - Number(b2.ts)
  );
  const toggleSort = () => setSortDir((d2) => d2 === "desc" ? "asc" : "desc");
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex h-screen overflow-hidden bg-background", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-1 flex-col overflow-hidden", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("main", { className: "flex-1 overflow-y-auto bg-background", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mx-auto max-w-6xl px-6 py-8", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-7", "data-ocid": "reports.page", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "font-display text-2xl font-bold text-foreground", children: "Health Reports" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-1 text-sm text-muted-foreground", children: "Visual analysis of your glucose and weight trends" })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "div",
            {
              ...
              children: [7, 14, 30].map((d2) => /* @__PURE__ */ jsxRuntimeExports.jsx(
                TimeRangeButton,
                {
                  value: d2,
                  active: timeRange === d2,
                  onClick: () => setTimeRange(d2)
                },
                d2
              ))
            }
        ...
        isLoading ? /* @__PURE__ */ jsxRuntimeExports.jsx(StatsSkeleton, {}) : /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-2 gap-4 lg:grid-cols-4", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(Card, { "data-ocid": "reports.stat.item.1", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(CardContent, { className: "pt-5", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "inline-flex h-9 w-9 items-center justify-center rounded-lg bg-primary/10 mb-3", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Droplets, { className: "h-4 w-4 text-primary" }) }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "font-display text-2xl font-bold text-primary", children: [
              ...
              avgGlucose != null && /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-sm font-normal text-muted-foreground ml-1", children: "mg/dL" })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 mt-1", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground", children: "Avg Glucose" }),
              avgGlucose != null && /* @__PURE__ */ jsxRuntimeExports.jsx(
                Badge,
                {
                  variant: avgInRange ? "secondary" : "destructive",
                  className: "text-[10px] px-1.5 py-0",
                  children: avgInRange ? "In Range" : "Out of Range"
                }
              )
            ] })
          ] }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(Card, { "data-ocid": "reports.stat.item.2", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(CardContent, { className: "pt-5", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "inline-flex h-9 w-9 items-center justify-center rounded-lg bg-primary/10 mb-3", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Activity, { className: "h-4 w-4 text-primary" }) }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-display text-2xl font-bold text-foreground", children: minGlucose != null && maxGlucose != null ? `${minGlucose}–${maxGlucose}` : "—" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground mt-1", children: "Glucose Range (mg/dL)" })
          ] }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(Card, { "data-ocid": "reports.stat.item.3", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(CardContent, { className: "pt-5", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "inline-flex h-9 w-9 items-center justify-center rounded-lg bg-secondary/10 mb-3", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Scale, { className: "h-4 w-4 text-secondary" }) }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "font-display text-2xl font-bold text-secondary", children: [
              latestWeight != null ? `${latestWeight.value}` : "—",
              latestWeight != null && /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-sm font-normal text-muted-foreground ml-1", children: latestWeight.unit })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 mt-1", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground", children: "Latest Weight" }),
              latestWeight && /* @__PURE__ */ jsxRuntimeExports.jsx(
                Badge,
                {
                  variant: "secondary",
                  className: "text-[10px] px-1.5 py-0",
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(Card, { "data-ocid": "reports.stat.item.4", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(CardContent, { className: "pt-5", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "inline-flex h-9 w-9 items-center justify-center rounded-lg bg-muted mb-3", children: /* @__PURE__ */ jsxRuntimeExports.jsx(TrendingUp, { className: "h-4 w-4 text-muted-foreground" }) }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-display text-2xl font-bold text-foreground", children: totalEntries }),
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { "data-ocid": "reports.glucose-chart.card", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(CardHeader, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between flex-wrap gap-2", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(CardTitle, { children: "Glucose Trends" }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-sm text-muted-foreground mt-0.5", children: [
                "Blood glucose readings over the last ",
                timeRange,
                " days"
              ] })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs(Badge, { variant: "outline", className: "text-xs", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "inline-block w-2 h-2 rounded-full bg-yellow-500 mr-1.5" }),
                "Low <70"
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs(Badge, { variant: "secondary", className: "text-xs", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "inline-block w-2 h-2 rounded-full bg-secondary mr-1.5" }),
                "Normal 70–140"
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs(Badge, { variant: "destructive", className: "text-xs", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "inline-block w-2 h-2 rounded-full bg-destructive mr-1.5" }),
                "High >140"
              ] })
            ] })
          ] }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(CardContent, { children: isLoading ? /* @__PURE__ */ jsxRuntimeExports.jsx(ChartSkeleton, { height: 260 }) : glucoseData.length > 0 ? /* @__PURE__ */ jsxRuntimeExports.jsx(ResponsiveContainer, { width: "100%", height: 260, children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
            LineChart,
            {
              data: glucoseData,
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { "data-ocid": "reports.weight-chart.card", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs(CardHeader, { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(CardTitle, { children: "Weight Progress" }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-sm text-muted-foreground", children: [
              "Body weight over the last ",
              timeRange,
              " days"
            ] })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(CardContent, { children: isLoading ? /* @__PURE__ */ jsxRuntimeExports.jsx(ChartSkeleton, { height: 230 }) : weightData.length > 0 ? /* @__PURE__ */ jsxRuntimeExports.jsx(ResponsiveContainer, { width: "100%", height: 230, children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
            BarChart,
            {
              data: weightData,
              margin: { top: 8, right: 16, left: 0, bottom: 0 },
              children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  Tooltip,
                  {
                    ...
                    formatter: (v2) => {
                      var _a;
                      return [
                        `${v2} ${((_a = weightFiltered[0]) == null ? void 0 : _a.unit) ?? "kg"}`,
                        "Weight"
                      ];
                    }
                  }
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  Legend,
                  {
                    formatter: () => {
                      var _a;
                      return `Weight (${((_a = weightFiltered[0]) == null ? void 0 : _a.unit) ?? "kg"})`;
                    },
                    iconType: "rect",
                    iconSize: 10,
                    wrapperStyle: { fontSize: 12 }
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { "data-ocid": "reports.history.card", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(CardHeader, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between flex-wrap gap-3", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(CardTitle, { children: "Health History" }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-sm text-muted-foreground mt-0.5", children: [
                ...
                children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx(
                    SelectTrigger,
                    {
                      ...
                      children: /* @__PURE__ */ jsxRuntimeExports.jsx(SelectValue, { placeholder: "Filter type" })
                    }
                  ),
                  /* @__PURE__ */ jsxRuntimeExports.jsxs(SelectContent, { children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx(SelectItem, { value: "all", children: "All Types" }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx(SelectItem, { value: "glucose", children: "Glucose" }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx(SelectItem, { value: "weight", children: "Weight" })
                  ] })
                ]
              }
            )
          ] }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(CardContent, { className: "p-0", children: isLoading ? /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-2 p-6", children: [1, 2, 3, 4, 5].map((i) => /* @__PURE__ */ jsxRuntimeExports.jsx(Skeleton, { className: "h-10 w-full rounded" }, i)) }) : filteredRows.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "div",
            {
              className: "flex flex-col items-center gap-3 py-14 text-center",
              "data-ocid": "reports.history.empty_state",
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex h-12 w-12 items-center justify-center rounded-full bg-muted", children: /* @__PURE__ */ jsxRuntimeExports.jsx(ChartNoAxesColumn, { className: "h-6 w-6 text-muted-foreground" }) }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm font-medium text-foreground", children: "No entries found" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground max-w-xs", children: "Try changing the type filter or add new health data." })
              ]
            }
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx(TableHeader, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs(TableRow, { className: "bg-muted/40", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(TableHead, { className: "w-[160px]", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
                Button,
                {
                  variant: "ghost",
                  size: "sm",
                  ...
                  children: [
                    "Date ",
                    /* @__PURE__ */ jsxRuntimeExports.jsx(SortIcon, { dir: sortDir })
                  ]
                }
              ) }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(TableHead, { className: "w-[80px]", children: "Time" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(TableHead, { className: "w-[100px]", children: "Type" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(TableHead, { className: "w-[100px] text-right", children: "Value" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(TableHead, { children: "Notes" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(TableHead, { className: "w-[100px]", children: "Status" })
            ] }) }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(TableBody, { children: filteredRows.map((row, i) => {
              const isGlucose = row.type === "Glucose";
              const status = isGlucose ? getGlucoseStatus(row.value) : null;
              return /* @__PURE__ */ jsxRuntimeExports.jsxs(
                TableRow,
                {
                  ...
                  children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx(TableCell, { className: "font-medium text-sm", children: formatDateFull(row.ts) }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx(TableCell, { className: "text-xs text-muted-foreground", children: formatTime(row.ts) }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx(TableCell, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-1.5", children: [
                      isGlucose ? /* @__PURE__ */ jsxRuntimeExports.jsx(Droplets, { className: "h-3.5 w-3.5 text-primary" }) : /* @__PURE__ */ jsxRuntimeExports.jsx(Scale, { className: "h-3.5 w-3.5 text-secondary" }),
                      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs font-medium", children: row.type })
                    ] }) }),
                    /* @__PURE__ */ jsxRuntimeExports.jsxs(TableCell, { className: "text-right font-semibold text-sm", children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsx(
                        "span",
                        {
                          className: isGlucose ? "text-primary" : "text-secondary",
                          children: row.value
                        }
                      ),
                      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs text-muted-foreground ml-1", children: row.unit })
                    ] }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx(TableCell, { className: "text-xs text-muted-foreground max-w-[200px] truncate", children: row.notes || /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "opacity-40", children: "—" }) }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx(TableCell, { children: status ? /* @__PURE__ */ jsxRuntimeExports.jsx(
                      Badge,
                      {
                        variant: status.inRange ? "secondary" : "destructive",
